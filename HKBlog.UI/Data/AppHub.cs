...
namespace HKBlog.UI.Data
{
    public class AppHub : Hub
    {
        ...
        public async void NewDispatchedProducts(List<DispatchProduct> products) 
        {
            await Clients.All.SendAsync("NewDispatchedProducts", products);
        }
        public async void ModifyDispatchedProducts(DispatchProduct product, string operation)
        {
            await Clients.All.SendAsync("ModifyDispatchedProducts", product, operation);
        }
    }
}
